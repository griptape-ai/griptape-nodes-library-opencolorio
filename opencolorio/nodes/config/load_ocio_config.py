...
class LoadOCIOConfig(DataNode):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        config_output_parameter = Parameter(
            ...
            output_type="dict",
            type="dict",
            tooltip="Loaded OCIO configuration data"
        )
        ...
        colorspaces_output_parameter = Parameter(
            ...
            output_type="list",
            type="list",
            tooltip="List of available color spaces in the config"
        )
    ...
    def process(self) -> None:
        ...
        try:
            ...
            try:
                ...
                raise ValueError("PyOpenColorIO is not installed. Please install it to use OpenColorIO nodes.")
